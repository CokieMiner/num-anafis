...
use super::gen_id::{E_MINUS, E_PLUS, E1, E2, E3};
...
mod tests {
    ...
    fn test_scalar(val: crate::scalar::Scalar) -> CliffordNumber {
    ...
    fn test_derived_identities() {
        ...
        assert!(
            (&eps() * &eps())
                .coeffs_slice()
                .iter()
                .all(crate::traits::Number::is_zero)
        );
    ...
    fn test_spectral_round_trip() {
        ...
        let eps = crate::scalar::Scalar::epsilon();
