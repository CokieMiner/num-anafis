...
///
/// Reference: [Miller52], [DLMF, §10.74]
pub(in crate::float_ops) fn compute_miller_start<I: SpecInt>(n: I) -> I {
...
#[inline]
pub(in crate::float_ops) fn horner_eval<T: SpecFloat>(x: T, coeffs: &[T]) -> T {
    let mut sum = T::zero();
...
#[inline]
pub(in crate::float_ops) fn horner_rational<T: SpecFloat>(x: T, num: &[T], den: &[T]) -> T {
