...
use crate::float_ops;
use crate::float_ops::{FloatType, from_int, to_int};
use crate::int_math;
use crate::int_math::IntType;
use crate::rational_math;
use crate::rational_math::{RationalType, is_integer, to_integer};
...
impl Scalar {
    ...
    #[inline]
    #[must_use]
    pub(crate) const fn from_int(value: IntType) -> Self {
    ...
    #[inline]
    #[must_use]
    pub(crate) fn from_rational(value: RationalType) -> Self {
    ...
    #[inline]
    #[must_use]
    pub(crate) fn from_float(value: FloatType) -> Self {
    ...
    #[must_use]
    pub(crate) fn to_float_repr(&self) -> FloatType {
        match &self.0 {
    ...
    pub(crate) fn is_nan_internal(&self) -> bool {
    ...
    /// Returns π computed at the current backend precision.
    #[must_use]
    pub fn pi() -> Self {
        Self::from_float_raw(float_ops::pi())
    }
...
impl Number for Scalar {
    ...
    fn gamma(&self) -> Self {
            ...
            && int_math::is_positive(&n)
        {
            ...
            while int_math::cmp(&k, &n) == Ordering::Less {
